  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-white border border-gray-100 rounded-xl px-4 py-3 shadow-lg">
        <p className="font-semibold text-sm text-charcoal-900">{data.name}</p>
...
export default function GrowthRadarChart({ categoryScores }: { categoryScores: GrowthCategoryScore[] }) {
    ...
    <ResponsiveContainer width="100%" height={280}>
      <RadarChart cx="50%" cy="50%" outerRadius="65%" data={data}>
        ...
        <PolarAngleAxis
          ...
          tickSize={8}
        />
        <Radar name="スコア" dataKey="value" stroke="#C4788A" strokeWidth={2} fill="#C4788A" fillOpacity={0.18} />
