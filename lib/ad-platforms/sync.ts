...
import { AdReport, AdPlatform, AdReportCategory } from "@/lib/growth-db/ad-report-types";
...
export async function syncAdReport(
  ...
  return upsertAdReport(storeId, yearMonth, platform, { ...normalized, accountId }, category);
}
