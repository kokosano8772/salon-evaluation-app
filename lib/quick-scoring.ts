...
export const QUICK_CATEGORIES: QuickCategory[] = [
  {
    ...
    question: {
      id: "quick_product",
      label: "技術・メニュー・サービスの質",
      hint: "お客様から見たサロン全体のクオリティを正直に評価してください",
      options: ["課題が多い", "平均以下", "業界標準", "高水準", "トップクラス"],
      scores: [0, 5, 10, 15, 20],
      optionDescriptions: [
        "クレームや不満があり、技術・メニューに課題を感じている",
        "悪くはないが、他店との差別化ができていない",
        "近隣の一般的なサロンと同じくらいのレベル",
        "リピーターや指名客に支えられている実力がある",
        "口コミ・紹介が絶えず、業界でも認知されている",
      ],
    },
  },
  {
    ...
    question: {
      id: "quick_customer",
      label: "リピート・口コミ・顧客の定着",
      hint: "お客様が何度も来てくれるか、紹介してくれるか、を総合的に見てください",
      options: ["ほぼリピートなし", "リピートが少ない", "まあまあリピートする", "よくリピートされる", "ほぼ全員がリピート"],
      scores: [0, 5, 10, 15, 20],
      optionDescriptions: [
        "新規ばかりで、2回目に来るお客様がほとんどいない",
        "リピート率が低く、常連がなかなか育たない",
        "ある程度リピートはあるが、まだ改善の余地がある",
        "常連客が多く、口コミや紹介も定期的にある",
        "高い再来率・指名率で、紹介が主な集客になっている",
      ],
    },
  },
  {
    ...
    question: {
      ...
      scores: [0, 4, 8, 11, 15],
      optionDescriptions: [
        "SNSもホームページも活用できておらず、集客が口コミ頼みの状態",
        "Googleマップや予約サイトには登録しているが更新していない",
        "InstagramなどSNSを定期的に更新している",
        "SNS・Google・HPなどを組み合わせてオンライン集客している",
