  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        optionDescriptions: [
          "ご新規客のリピート率0〜20% / 2回目のご来店されるお客様が少ない",
          "ご新規客のリピート率21〜35% / リピート率が低く、常連がなかなか育たない",
          "ご新規客のリピート率36〜50% / ある程度リピートはあるが、まだ改善の余地がある",
          "ご新規客のリピート率51〜60% / 常連客が多く、口コミや紹介も定期的にある",
          "ご新規客のリピート率61%以上 / 高い再来率・指名率で、既存顧客からの紹介が主な集客になっている",
        ],
      },
      {
