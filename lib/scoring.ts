...
export const CATEGORIES: Category[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        optionDescriptions: [
          "ホームケア商品や追加メニューをほとんど提案しない",
          "気が向いたときや聞かれたときだけ提案する",
          "毎回意識してシャンプーや薬剤などを提案している",
          "カルテや手順書をもとに必ず提案する流れができている",
          "物販の月間売上が10万円以上あるなど結果が出ている",
          "物販比率が高く、提案の仕組みが完成している",
        ],
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["30%未満", "30〜50%", "50〜65%", "65〜80%", "80%以上"],
        optionDescriptions: [
          "初めて来た10人のうち3人以下しか2回目に来ない",
          "初めて来た10人のうち3〜5人が2回目に来る",
          "初めて来た10人のうち5〜6人が2回目に来る（平均的）",
          "初めて来た10人のうち7人近くが2回目に来る（良い水準）",
          "初めて来た10人のうち8人以上が2回目に来る（とても高い）",
        ],
      },
      {
    ...
    questions: [
      {
        ...
        options: ["ほぼなし", "最低限の情報のみ", "写真・雰囲気も載せている", "動画・採用サイトがある"],
        optionDescriptions: [
          "ハローワークなどに最低限の情報があるだけ、またはない",
          "求人サイトに給与と仕事内容だけ載っている",
      ...
      },
      {
        ...
        options: ["応募窓口がない", "求人サイトのみ", "SNSからも応募できる", "LINE・複数から応募できる"],
        optionDescriptions: [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["特になし", "見て覚えてもらう", "定期的な勉強会あり", "カリキュラムが整っている"],
        optionDescriptions: [
